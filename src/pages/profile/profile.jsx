...
const Profile = () => {
  ...
  return (
    <Container className="my-4 containerCard"style={{borderRadius:"20px"}}>
      <Row style={{background:"#111",marginTop:"20px",borderRadius:"30px"}}>
        <div style={{width:"100%",height:"70px",background:"#32cd32",borderTopRightRadius:"30px", borderTopLeftRadius:"30px"}}> <EditProfile/></div>
        <Col xs={12} md={4} className="d-flex justify-content-center align-items-center">
          <Image className='imgProfile' style={{ width: "200px", height: "200px", objectFit: "cover", objectPosition: "center",marginBottom:"10px",border:"4px solid #32cd32" }} src={userData.profilePictureUrl || "https://via.placeholder.com/200x200"} roundedCircle />
        </Col>
        ...
        <div style={{display:"flex", justifyContent:"center"}}> <div className='kotakText'> <p  className='pEmail'>{userData.phoneNumber}</p></div></div>
          ...
          <div className='containerData'>
          <img className='emailImg' src={user} alt="email" style={{width:"40px",backgroundColor:"#32cd32",padding:"5px",borderRadius:"50%",}}/>
